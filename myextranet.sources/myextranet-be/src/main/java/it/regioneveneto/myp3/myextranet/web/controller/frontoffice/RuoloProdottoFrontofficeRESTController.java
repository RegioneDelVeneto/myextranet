...
@RestController
@RequestMapping("/frontoffice/ruolo-prodotto")
@Tag(name = "tag_ruolo-prodotto", description = "Ruolo Prodotto")
public class RuoloProdottoFrontofficeRESTController {
    private static final Logger LOG = LoggerFactory.getLogger(RuoloProdottoFrontofficeRESTController.class);
