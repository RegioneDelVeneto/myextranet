...
public interface ComuneService {
	...
	PagedData<ComuneDTO> getComuniByProvincia(ProvinciaDTO provincia, int pageNumber, int pageSize, String sortProperty,
			String sortDirection);
	
	PagedData<ComuneDTO> getComuni(ComuneFilterDTO comuneFilter, int pageNumber, int pageSize, String sortProperty, String sortDirection);
