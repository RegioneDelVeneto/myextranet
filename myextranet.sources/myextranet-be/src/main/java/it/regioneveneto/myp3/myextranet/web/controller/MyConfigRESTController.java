...
@Tag(name = "tag_myconfig", description = "myconfig")
public class MyConfigRESTController {

    private static final Logger LOG = LoggerFactory.getLogger(MyConfigRESTController.class);
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(description = "GET per ottenere val su myconfig da codice",
    ...
    public ResponseEntity<ConfItemDto> getItemByCode(
        ...
        LOG.debug("MyConfigRESTController --> get per item by code {}.", codice);
        
        ConfItemDto configItem = this.myConfigService.getItem(codice);
        LOG.debug("MyConfigRESTController --> get per item by code eseguita con successo.");
