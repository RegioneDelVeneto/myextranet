...
@RestController
@RequestMapping("/frontoffice/comune")
@Tag(name = "tag_comune", description = "Comune")
public class ComuneFrontofficeRESTController {
    private static final Logger LOG = LoggerFactory.getLogger(ComuneFrontofficeRESTController.class);
