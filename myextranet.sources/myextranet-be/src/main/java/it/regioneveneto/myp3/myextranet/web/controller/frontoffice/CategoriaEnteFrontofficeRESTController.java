...
@RestController
@RequestMapping("/frontoffice/categoria-ente")
@Tag(name = "tag_categoria-ente", description = "Categoria Ente")
public class CategoriaEnteFrontofficeRESTController {
    private static final Logger LOG = LoggerFactory.getLogger(CategoriaEnteFrontofficeRESTController.class);
    ...
    public ResponseEntity<List<CategoriaEnteDTO>> getAllCategorie(
        ...
        LOG.debug("CategoriaEnteFrontofficeRESTController --> GET Lista categorie." );
        ...
        LOG.debug("CategoriaEnteFrontofficeRESTController --> GET Lista categorie eseguito con successo.");
