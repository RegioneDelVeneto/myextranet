...
import it.regioneveneto.myp3.myextranet.web.dto.EventoDTO;

@RestController
@RequestMapping("/evento")
@Tag(name = "tag_evento", description = "Evento")
public class EventoRESTController {
    private static final Logger LOG = LoggerFactory.getLogger(EventoRESTController.class);
    ...
    public ResponseEntity<EventoDTO> getEvento(
        ...
        LOG.debug("EventoRESTController --> GET evento" );
        ...
        EventoDTO eventoDTO = ObjectMapperUtils.map(evento, EventoDTO.class);
        ...
        LOG.debug("EventoRESTController --> GET evento eseguito con successo.");
